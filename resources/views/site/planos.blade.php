        ...
        <section class="bg-light py-5">
            <div class="container px-5 my-5">
                <div class="text-center mb-5">
                    <h1 class="fw-bolder">Planos Diarios </h1>
                ...
                <div class="row gx-5 justify-content-center">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="card mb-5 mb-xl-0">
                            <div class="card-body p-5">
                                ...
                                <div class="d-grid"><a class="btn btn-outline-primary" href="/reserva">Escolha o plano</a></div>
                            </div>
                        </div>
                    </div>
                    <!-- Pricing card pro-->
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="card">
                            <div class="card-body p-5">
                                <div class="small text-uppercase fw-bold text-muted">Master</div>
                                <div class="mb-3">
                                    <span class="display-4 fw-bold">$350 </span>
                                    <span class="text-muted">/ diaria.</span>
                                </div>
                                <ul class="list-unstyled mb-4">
                                    <li class="mb-2">
