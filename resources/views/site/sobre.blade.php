                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xxl-6">
                        <div class="text-center my-5">
                            <h1 class="fw-bolder mb-3">Nossa Historia.</h1>
                            <p class="lead fw-normal text-muted mb-4">Em 10 de março de 2021, será realizada a cerimônia de inauguração dos diplomatas. Inicialmente eram 17 quartos e era disponibilizado apenas serviço de pequeno-almoço, aos poucos foram sendo criados novos serviços e a nossa estrutura foi ampliada. Em julho de 2021, nossa primeira expansão foi para construir uma piscina e sauna. Posteriormente, em novembro de 2021, abrimos a atual sala de café da manhã, construímos um novo apartamento e áreas como playgrounds, Quadra e novos estacionamentos.</p>
                            <a class="btn btn-primary btn-lg" href="#scroll-target">Leia nossa historia</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5 mb-5 mb-xl-0">
                        <div class="text-center">
                            ...
                            <h5 class="fw-bolder">Douglas Brant</h5>
