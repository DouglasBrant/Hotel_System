                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-5">
                            <h1 class="fw-bolder">Diplomata</h1></p>
                        </div>
                    </div>
                </div>
                <div class="row gx-5">
                    <div class="col-5"><img class="img-fluid rounded-3 mb-5" src="img/portfolio/Entradahotel.jpg" alt="..." /></div>
                    <div class="col-7"><img class="img-fluid rounded-3 mb-5" src="img/portfolio/restaurante.jpg" alt="..." /></div>
                    <div class="col-lg-5"><img class="img-fluid rounded-3 mb-5" src="img/portfolio/Bar.jpg" alt="..." /></div>
                    <div class="col-lg-6"><img class="img-fluid rounded-3 mb-5" src="   img/portfolio/spa.jpg" alt="..." /></div>
                </div>
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-5">
